<template>
  <div v-if="!isLoading">
    <useHead>
      <title>{{ post?.title || 'Post' }} - Tiago França</title>
              ...
              <div class="sticky top-20 space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-slate-800 p-4 rounded-lg">
                  ...
                  <div class="flex gap-2">
                    ...
                    >
                      <iconify-icon icon="fa7-brands:twitter" class="w-4 h-4"></iconify-icon>
                    </a>
                    <a
                      href="#share-linkedin"
                      class="p-2 rounded-lg bg-gray-200 dark:bg-slate-700 hover:bg-red-600 hover:text-white transition-colors"
                    ...
                    >
                      <iconify-icon icon="fa7-brands:linkedin" class="w-4 h-4"></iconify-icon>
                    </a>
                    <button
                      @click="copyLink"
                      class="p-2 rounded-lg bg-gray-200 dark:bg-slate-700 hover:bg-red-600 hover:text-white transition-colors"
                    ...
                    >
                      <iconify-icon icon="fa7-solid:link" class="w-4 h-4"></iconify-icon>
                    </button>
                  </div>
                </div>
