            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div class="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 sticky top-24">
                            ...
                            <div>
                                ...
                                <button
                                    ...
                                    class="w-full mt-6 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 rounded-lg transition-colors"
                                >
                                    {{ $t('search.clearAll') }}
                                </button>
                            </div>
                    ...
                    <div class="lg:col-span-3">
                        ...
                        <!-- Results List -->
                        <div v-else-if="hasActiveFilters && filteredPosts.length > 0" class="space-y-6">
                            <article
